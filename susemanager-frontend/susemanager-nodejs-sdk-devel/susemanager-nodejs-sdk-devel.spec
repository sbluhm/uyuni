...
Provides:	npm(nodejs-babel-plugin-transform-modules-amd) = 7.7.5
Provides:	npm(nodejs-babel-plugin-proposal-class-properties) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-react-jsx) = 7.7.7
Provides:	npm(nodejs-babel-plugin-transform-exponentiation-operator) = 7.7.4
Provides:	npm(nodejs-babel-helper-regex) = 7.5.5
Provides:	npm(nodejs-babel-plugin-transform-for-of) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-spread) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-optional-catch-binding) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-optional-catch-binding) = 7.7.4
Provides:	npm(nodejs-babel-types) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-block-scoped-functions) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-computed-properties) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-unicode-property-regex) = 7.7.7
Provides:	npm(nodejs-babel-helper-split-export-declaration) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-typeof-symbol) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-json-strings) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-json-strings) = 7.7.4
Provides:	npm(nodejs-babel-helper-replace-supers) = 7.7.4
Provides:	npm(nodejs-babel-runtime) = 7.7.7
Provides:	npm(nodejs-babel-plugin-transform-modules-commonjs) = 7.7.5
Provides:	npm(nodejs-babel-plugin-transform-react-jsx-source) = 7.7.4
Provides:	npm(nodejs-babel-highlight) = 7.5.0
Provides:	npm(nodejs-babel-plugin-transform-classes) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-async-generator-functions) = 7.7.4
Provides:	npm(nodejs-babel-helper-call-delegate) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-jsx) = 7.7.4
Provides:	npm(nodejs-babel-parser) = 7.7.7
Provides:	npm(nodejs-babel-plugin-transform-sticky-regex) = 7.7.4
Provides:	npm(nodejs-babel-helpers) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-duplicate-keys) = 7.7.4
Provides:	npm(nodejs-babel-runtime-corejs3) = 7.7.7
Provides:	npm(nodejs-babel-plugin-transform-named-capturing-groups-regex) = 7.7.4
Provides:	npm(nodejs-babel-template) = 7.7.4
Provides:	npm(nodejs-babel-polyfill) = 7.7.0
Provides:	npm(nodejs-babel-helper-simple-access) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-dotall-regex) = 7.7.7
Provides:	npm(nodejs-babel-helper-plugin-utils) = 7.0.0
Provides:	npm(nodejs-babel-plugin-transform-flow-strip-types) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-async-generators) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-new-target) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-arrow-functions) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-object-rest-spread) = 7.7.7
Provides:	npm(nodejs-babel-preset-env) = 7.7.7
Provides:	npm(nodejs-babel-plugin-syntax-dynamic-import) = 7.7.4
Provides:	npm(nodejs-babel-plugin-proposal-dynamic-import) = 7.7.4
Provides:	npm(nodejs-babel-helper-module-imports) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-react-display-name) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-reserved-words) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-literals) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-top-level-await) = 7.7.4
Provides:	npm(nodejs-babel-helper-module-transforms) = 7.7.5
Provides:	npm(nodejs-babel-plugin-transform-react-jsx-self) = 7.7.4
Provides:	npm(nodejs-babel-helper-optimise-call-expression) = 7.7.4
Provides:	npm(nodejs-babel-preset-react) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-async-to-generator) = 7.7.4
Provides:	npm(nodejs-babel-helper-builder-binary-assignment-operator-visitor) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-member-expression-literals) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-destructuring) = 7.7.4
Provides:	npm(nodejs-babel-traverse/node_modules/ms) = 2.1.2
Provides:	npm(nodejs-babel-traverse/node_modules/debug) = 4.1.1
Provides:	npm(nodejs-babel-traverse) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-unicode-regex) = 7.7.4
Provides:	npm(nodejs-babel-plugin-syntax-flow) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-object-super) = 7.7.4
Provides:	npm(nodejs-babel-helper-define-map) = 7.7.4
Provides:	npm(nodejs-babel-helper-annotate-as-pure) = 7.7.4
Provides:	npm(nodejs-babel-helper-create-class-features-plugin) = 7.7.4
Provides:	npm(nodejs-babel-helper-remap-async-to-generator) = 7.7.4
Provides:	npm(nodejs-babel-helper-create-regexp-features-plugin) = 7.7.4
Provides:	npm(nodejs-babel-helper-hoist-variables) = 7.7.4
Provides:	npm(nodejs-babel-preset-flow) = 7.7.4
Provides:	npm(nodejs-babel-helper-member-expression-to-functions) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-parameters) = 7.7.7
Provides:	npm(nodejs-babel-plugin-syntax-object-rest-spread) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-template-literals) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-function-name) = 7.7.4
Provides:	npm(nodejs-babel-generator) = 7.7.7
Provides:	npm(nodejs-babel-core/node_modules/ms) = 2.1.2
Provides:	npm(nodejs-babel-core/node_modules/debug) = 4.1.1
Provides:	npm(nodejs-babel-core) = 7.7.7
Provides:	npm(nodejs-babel-plugin-transform-modules-systemjs) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-regenerator) = 7.7.5
Provides:	npm(nodejs-babel-helper-explode-assignable-expression) = 7.7.4
Provides:	npm(nodejs-babel-helper-wrap-function) = 7.7.4
Provides:	npm(nodejs-babel-helper-get-function-arity) = 7.7.4
Provides:	npm(nodejs-babel-helper-function-name) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-property-literals) = 7.7.4
Provides:	npm(nodejs-babel-helper-builder-react-jsx) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-modules-umd) = 7.7.4
Provides:	npm(nodejs-babel-code-frame) = 7.5.5
Provides:	npm(nodejs-babel-plugin-transform-shorthand-properties) = 7.7.4
Provides:	npm(nodejs-babel-plugin-transform-block-scoping) = 7.7.4
